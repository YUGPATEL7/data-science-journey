...
# for emp in employees:
#     if emp[1] is None or emp[1] == " ":
#         employees.remove(emp)

# print(len(employees))


# salary = sum(emp[2] for emp in employees if emp[2] is not None )
# avg = len(employees)

# for emp in employees:
#     if emp[2] is None or emp[2] == "":
#         emp[2] = salary/avg
#         print("done")
#         print(emp)
# print(salary)
...
# for emp in employees:
#     if emp[3] is None or  emp[3] == "":
#         emp[3] = "Unknow"
#         print("done")
#         print(emp)

# print("Total Emp:" , len(employees))
# print(employees)
